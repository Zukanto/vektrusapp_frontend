/*
  ...
  4. Functions
    - `concat_text` RPC for atomic text concatenation during streaming
*/
...
BEGIN
  ...
  DROP POLICY IF EXISTS "Team members can manage AI config" ON team_ai_config;
  ...
  -- Policy for updating AI config (team members only)
